...
The data loaded from `housing.txt` contained several missing values (`NA`s).  The table below shows a summary of the proportion of `NA`s in each column.
...
```{r echo=F fig1, fig.cap="Overview of the missing data"}
