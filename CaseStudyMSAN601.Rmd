...
The variables were further analysed for ordered categorical variables. We found that some variables indicating quality or condition made more sense when they where ordered. For example, the variable `ExterQual` consisted of multiple levels such as 'Excellent', 'Poor' etc.  Such variables need to be considered as ordinal factors as they is a inherent rank.
...
Y_pred_Morty <- predict(ols.fit, data.frame(XMorty_lasso), interval="confidence", level = 0.95)
