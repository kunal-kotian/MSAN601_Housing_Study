...
```{r fig1, fig.cap="Overview of the missing data", echo=F}
...
In the case of several categorical variables, the data dictionary stated that `NA` represented a specific category denoting the absence of the entity tracked by the 
